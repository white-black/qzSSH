	...
	<div class="content">
		...
		<div class="content-grid">
			...
			<div class="col-md-8 food-grid">
				<s:iterator value="resumes" status="st">
					<div class="row cup-in ">
						<div class="col-md-7">
							<p><s:property value="tbUser.URelname"/></p>
							<div class="clearfix"> </div>
						</div>
						<div class="col-md-5">
							<s:property value="rsType"/>
							<p><a href="redirectResume.action?id=<s:property value="rsId"/>">查看简历信息</a></p>
							<div class="clearfix"> </div>
						</div>
						<div class="clearfix"> </div>
					</div>
				...
				<div style="font-size:20px;"> 
                    <!-- 定义pageNumber值为1的URL值，以及【首页】链接 -->
						...
						<s:url id="lastPage" action='getAllResumes'>
							<s:param name="pageNumber">
